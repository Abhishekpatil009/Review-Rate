...
/* ⭐ STAR COMPONENT (MEMOIZED FOR PERFORMANCE) */
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        ...
        <div className="bg-white rounded-xl shadow p-6 mb-6">
          <div className="flex justify-between gap-6">
            ...
            <div className="text-right">
              ...
              <button className="mt-3 bg-purple-600 hover:bg-purple-700 transition text-white px-4 py-2 rounded">
                + Add Review
              </button>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow p-6">
          <p className="text-gray-400 mb-4">
            Result Found: {reviewCount}
          </p>

          {company.reviews.map((review, idx) => (
            <div key={idx} className="border-b pb-4 mb-4 last:border-none">
